...
const AddWorkout = ({ onAddWork }: onAddWorkType) => {
  ...
  return (
    <Card className="w-[350px] shadow-md">
      <CardHeader>
        <CardTitle className="text-lg font-semibold">Add Workout</CardTitle>
        <CardDescription className="text-sm text-gray-500">
          Enter your workout details below to keep track of your progress.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            {selectedWorkout && (
              <>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel htmlFor="speed">Speed (km/h) (if applicable)</FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          id="speed"
